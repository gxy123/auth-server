...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    public Docket innerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gxy.auth.web.controller"))
    ...
    public Docket openApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gxy.auth.web.api"))
                .paths(PathSelectors.any())
                .build();
    }
